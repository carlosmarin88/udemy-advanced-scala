...
//  val aFuture = Future(calculateMeaningOfLife)(global)
 ...
 /* aFuture.onComplete(t => t match{
    ...
    case Failure(e) => println(s"I've failed with $e")
  })
*/
...
*/
  ...
  object BankingApp {
    ...
    def purchase(username: String, item: String, merchantName: String, cost: Double): String = {
      ...
      Await.result(transactionStatusFuture, 2.second) // implicit conversions -> pimp my library
    }
  }

  println(BankingApp.purchase("Carlos", "Iphone 12", "the rock jvm store", 3000))
   ...
   */
    ...
    */
  def fulfilImmediately[T](value: T): Future[T] = Future.successful(value)
  /*
    2 - in sequence
  */
  ...
  */
  ...
  first(fast,slow).foreach(r => println(s"FIRST: $r"))
  last(fast, slow).foreach(r => println(s"LAST: $r"))
