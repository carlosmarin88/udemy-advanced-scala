      ...
      while (true) {
        buffer.synchronized {
          /*
            ...
            two cons are waiting notifies ONE consumer,
            notifies on buffer
          ...
          */
          ...
          // there must be at least ONE value on the buffer
          val x = buffer.dequeue()
  ...
  */
  ...
  case class Friend(name: String) {
    def bow(other: Friend) = {
      this.synchronized{
        println(s"$this: I am bowing to my friends $other")
        other.rise(this)
  ...
  //new Thread(()=> pierre.bow(sam)).start() // pierre's lock | then sam' lock
